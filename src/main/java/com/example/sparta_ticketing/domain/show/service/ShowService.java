...
public class ShowService {
     ...
     * 특정 공연 조회
     *
     * @param auther (인증된 유저 정보)
     * @param showId (조회할 공연 Id)
     * @return ShowResponseDto
     */
    public ShowResponseDto getShow(Auther auther, Long showId) {
        return null;
    }
     ...
     */
    public void updateShow(Auther auther, Long showId, UpdateShowRequestDto requestDto) {
     ...
     */
    public void deleteShow(Auther auther, Long showId) {
