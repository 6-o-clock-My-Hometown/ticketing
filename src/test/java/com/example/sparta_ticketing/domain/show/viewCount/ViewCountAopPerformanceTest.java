package com.example.sparta_ticketing.domain.show.viewCount;
...
public class ViewCountAopPerformanceTest {
    ...
    @Autowired
    public ViewCountAopPerformanceTest(ShowRepository showRepository,
    ...
    public void DB_공연조회_성능테스트() {
        ...
        Show show = showRepository.save(createShow(director));
